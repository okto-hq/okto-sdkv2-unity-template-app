...
namespace OktoSDK
{
    ...
    CustomLogger.LogWarning("GenerateDefaultTheme is only supported in the Unity Editor.");
        ...
        private static void ApplyDefaultValues(OnboardingTheme theme)
        {
            ...
            themeSettings.bodyBackground = "#ffffff";
            themeSettings.bodyColorTertiary = "#adb5bd";
            themeSettings.accentColor = "#5166ee";
            themeSettings.buttonFontWeight = "500";
            themeSettings.borderColor = "rgba(22, 22, 22, 0.12)";
            themeSettings.strokeDivider = "rgba(22, 22, 22, 0.06)";
            ...
            themeSettings.successColor = "#28a745";
            themeSettings.warningColor = "#ffc107";
            themeSettings.errorColor = "#f75757";
            themeSettings.textPrimary = "#161616";
            themeSettings.textSecondary = "#707070";
            themeSettings.backgroundSurface = "#f8f8f8";
