...
{
    /// <summary>
    /// Test class for Decoding to demonstrate decoding various function calls
    /// </summary>
    public class DecodingTest : MonoBehaviour
    {
        ...
        {
            Decoding.DecodedCallData result;
            List<string> testResults = new List<string>();
            int totalTests = 0;
            int passedTests = 0;
            
            void AddTestResult(string testName, Decoding.DecodedCallData decodedData, bool expectSuccess)
            {
                totalTests++;
        ...
        public Decoding.DecodedCallData TestDepositWithMetaTxDecoding()
        {
        ...
        public Decoding.DecodedCallData TestWithdrawToUserDecoding()
        {
        ...
        public Decoding.DecodedCallData TestWithdrawWithSignatureDecoding()
        {
        ...
        public Decoding.DecodedCallData TestCollectTournamentFeeDecoding()
        {
        ...
        public Decoding.DecodedCallData TestWithdrawTournamentFeeDecoding()
        {
        ...
        public Decoding.DecodedCallData TestSetTrustedSignerDecoding()
        {
        ...
        public Decoding.DecodedCallData TestSetMultiSigOwnersDecoding()
        {
        ...
        public Decoding.DecodedCallData TestEmergencyWithdrawDecoding()
        {
        ...
        public Decoding.DecodedCallData TestPauseDecoding()
        {
        ...
        public Decoding.DecodedCallData TestUnpauseDecoding()
        {
        ...
        public Decoding.DecodedCallData TestTransferERC20Decoding()
        {
        ...
        public Decoding.DecodedCallData TestApproveERC20Decoding()
        {
        ...
        public Decoding.DecodedCallData TestTransferFromERC20Decoding()
        {
        ...
        public Decoding.DecodedCallData TestPermitDecoding()
        {
        ...
        public Decoding.DecodedCallData TestUnsupportedTypeDecoding()
        {
