...
{
    public static class AbiEncoding
    {
        ...
        public static object[] ParseInputParameters(string parametersText)
        {
        ...
        public static string EncodeFunctionData(string abiJson, string functionName, object[] parameters)
        {
            try
            {
        ...
        private static object ParseParameter(Parameter parameter, string value)
        {
            try
            {
        ...
        private static object ParseArrayParameter(Parameter parameter, string value)
        {
        ...
        private static Type GetSystemType(string abiType)
        {
        ...
        private static BigInteger ParseBigInteger(string value, bool signed)
        {
            value = value.Trim();
        ...
        private static byte[] ParseDynamicBytes(string value)
        {
            value = value.Trim();
            if (!value.StartsWith("0x"))
                value = "0x" + value;
        ...
        private static byte[] ParseFixedBytes(string value, int length)
        {
